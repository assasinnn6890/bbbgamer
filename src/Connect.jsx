...
const Connect = ({setLogin,login}) => {
    ...
    }, [aeSdk, address, getBalance,setLogin]);
                ...
                flex flex-col items-start '>
                    ...
                    <React.Fragment>
                        ...
                        <div className='flex items-center justify-center h-screen'>
                            ...
                            <h2 className='text-black text-lg font-bold mb-4'>Navigate Crypto Realms</h2>
                                <p className='text-black text-center mb-4 font-serif'>Dive into the App Excitement, Where Every Transaction Sparks Progress, and Your Financial Journey Begins with Unmatched Convenience!</p>
                                
                                <button className='text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 dark:bg-blue-600 dark:hover:bg-blue-500 focus:outline-none dark:focus:ring-blue-500 '
